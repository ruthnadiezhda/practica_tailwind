...
export default function NavBar() {
  ...
  //Estado global para la lista de los productos del carrito
  const cartProducts = useSelector((store) => store.products.cart);
  ...
  return (
    ...
    ">
      <div className="
      sm:w-full sm:flex sm:justify-between sm:items-center sm:grow
      w-full flex items-center justify-between 
      ">
        <Link to="/" className="
        sm:w-1/3 sm:flex sm:items-center sm:grow sm:justify-start
        w-1/3 flex items-center grow justify-start
        ">
          <img
            className="sm:h-[50px]"
        ...
        w-1/3 flex items-center grow justify-end
        ">
          <li id="facebook" className="sm:h-[50px] sm:w-[50px]
          h-auto w-auto items-center justify-center
          ">
            <a className="sm:h-[50px] sm:w-[50px]
            h-auto w-auto items-center justify-center
            " href="https://facebook.com">
              <img
                className="sm:h-[50px] sm:p-[10px] sm:w-[50px]"
          ...
          <li id="instagram" className="sm:h-[50px] sm:w-[50px]
          h-auto w-auto items-center justify-center
          ">
            <a className="sm:h-[50px] sm:w-[50px]
            h-auto w-auto items-center justify-center
          ...
          <li id="cart" className="sm:h-[50px] sm:w-[50px]
          h-auto w-auto items-center justify-center
          ">
            <Link className="sm:h-[50px] sm:w-[50px]
            h-auto w-auto items-center justify-center
            " to="/cart">
              <img
                className="sm:h-[50px] sm:p-[10px] sm:w-[50px]"
              ...
              { cartProducts && cartProducts.length> 0 && (
                <span className="sm:h-[50px] sm:p-[10px] sm:w-[50px]">{cartProducts.length}</span>
              )}
            </Link>
          </li>
        </ul>
